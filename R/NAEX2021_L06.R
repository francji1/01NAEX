...
# read data
rate_experiment <- read.table("data/Pilot_Plant_Filtration_Rate_Experiment.csv",
                              header=TRUE, sep = ";")
...
# halfnormal plot from DoE.base package
? halfnormal
halfnormal(lm(Filtration~A*B*C*D,  data=rate), alpha = 0.01)
halfnormal(lm(Filtration~A*B*C*D,  data=rate), alpha = 0.01)
# if pure error degrees of freedom => method = "LW98"  or "EM08"
